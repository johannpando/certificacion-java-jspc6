...
public class Principal {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		int op;
		//Variables d, n, t, que representan a dni, nombre y teléfono, respectivamente.
		String d,n,t;
		...
		do{
			...
			case 1:
				...
				if(ag.agregar(n, d, t)){
					...
					System.out.println("La persona con dni: '" + d + "' ya existe. No se ha podido añadir.");
				}
				break;
			case 2:
				...
				if(p != null){
					System.out.println("Persona encontrada, sus datos son los siguientes:");
			...
			case 3:
				...
				if(ag.eliminar(d)){
					...
					System.out.println("No se ha encontrado a ninguna persona con el dni proporcionado. No se ha podido eliminar");
				}
				break;
			case 4:
